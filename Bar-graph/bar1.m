...
methods = {'Principle Components Analysis', 'Hierarchical Saliency','Saliency Filter', 'Frequency Tune', 'Region-base Fully Convolutional Networks', 'Attention via Information Maximization', 'It' ,'Graph Based Visual Saliency','Boolean Map', 'Discriminative Regional Feature Integration', 'Multi-task Deep Saliency'};
